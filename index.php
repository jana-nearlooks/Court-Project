...
<head>
		...
		<!-- Bootstrap core CSS -->
	    <link href="assets/css/bootstrap.mins.css" type="text/css" rel="stylesheet" />
	...
	<body>
        ...
        <nav id="navbar" class="navbar navbar-expand-lg fixed-top sticky">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="assets/img/court logo.png" alt="" style="width:50px">
                </a>
        ...
        <section class="bg-half-170 d-table w-100" id="home">
            <div class="bg-overlay bg-gradient-primary opacity-1"></div>
            <div class="container">
                <div class="row align-items-center mt-5">
                    <div class="col-lg-6 col-md-7">
                        <div class="title-heading mt-4">
                            <h3>வாய்மையே வெல்லும்</h3>
                            <h1 class="heading mb-3">Welcome to <span class="text-primary typewrite" data-period="2000" data-type='[ "E-Court"]'> <span class="wrap"></span> </span></h1>
                            <p class="para-desc text-muted">Justice is not a destination; it's a journey we take together.</p>
                            <div class="mt-4">
                                <a href="login.php" class="btn btn-outline-primary rounded">Login</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-6 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div class="position-relative">
                            <img src="assets/img/justice.png" class="rounded-md img-fluid mx-auto d-block" alt="" >
                            <div class="play-icon">
                                <a href="#!" data-type="youtube"  class="play-btn lightbox">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                            <div class="text-center">
                                <p class="mb-0">©  <a href="https://shreethemes.in/" target="_blank" class="text-reset"> Navi Promotions </a>| Designed by  <a href="https://shreethemes.in/" target="_blank" class="text-reset">KRJ</a>.</p>
                            </div>
                        </div>
