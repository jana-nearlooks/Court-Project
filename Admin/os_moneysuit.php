                                ...
                                <div class="row g-3">
                                  ...
                                  <div class="col-md-3">
                                    <label for="state" class="form-label"
                                      >Notation</label
                                    >
                                    <select class="form-select notation" id="state">
                                      <option value=""></option>
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <input
                                      type="text"
                                      class="form-control notationName"
                                      id="cc-cvv"
                                      placeholder=""
                                      required=""
                                    />
                                  ...
                                  <div class="col-md-6">
                                    <label for="state" class="form-label"
                                      >பாலினம்:</label
                                    >
                                    <select class="form-select gender" id="state">
                                  ...
                                  <div class="col-md-6">
                                    <label for="state" class="form-label"
                                      >மதம்:</label
                                    >
                                    <select class="form-select religion" id="state">
                                  ...
                                  <div class="col-md-4">
                                    <label for="state" class="form-label"
                                      >தாலுகா:</label
                                    >
                                    <select class="form-select taluk" id="state">
                                  ...
                                  <div class="col-md-4">
                                    <label for="state" class="form-label"
                                      >மாவட்டம்:</label
                                    >
                                    <select class="form-select district" id="state">
                                      <option value="திண்டுக்கல்">திண்டுக்கல்</option>
...
<script>
  $(document).ready(function () {
    var counter = 1; // Counter for generating unique ids

    // Function to update IDs and classes based on the counter
    function updateIdsAndClasses(section, counter) {
      ...
      // Update complainant count in the heading
    ...
    // Add button click event using event delegation
    $(document).on("click", ".add-btn", function () {
      // Clone the complainant section and append it after the last one
      var clonedSection = $(".complainant").last().clone();

      // Update IDs, classes, and complainant count in the cloned section
      updateIdsAndClasses(clonedSection, counter);

      // Insert the cloned section after the last one
    ...
    $(document).on("click", ".delete-btn", function () {
      // Ensure there is more than one complainant section before deleting
      if ($(".complainant").length > 1) {
        // Remove the closest complainant section
